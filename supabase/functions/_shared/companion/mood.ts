...
// Source: packages/core/src/companion/mood.ts
// Regenerate with: node scripts/syncCompanion.mjs

import type { CompanionEvent, CompanionEventType, CompanionMood, LifeContext, PersonalityTraits } from './types.ts';
import { DAY, HOUR, clamp01 } from './util.ts';
