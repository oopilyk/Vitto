...
create table public.pets (
  ...
  pushing_strength integer not null default 0 check (pushing_strength between 0 and 100),
  pulling_strength integer not null default 0 check (pulling_strength between 0 and 100),
  leg_strength integer not null default 0 check (leg_strength between 0 and 100),
